...
object AESUtils {
  ...
  //TODO Why not SecureRandom?
  lazy val randomBytes = new RandomBytes()

  @TargetApi(26)
  def base64(key: Array[Byte]): String = Base64.getEncoder.encodeToString(key)
  @TargetApi(26)
  def base64(key: String): Array[Byte] = Base64.getDecoder.decode(key)
